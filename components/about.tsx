    ...
    <section className="py-24 px-6 border-t border-[#27272A]">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Text side */}
          <div>
            <h2 className="font-headline font-bold text-3xl sm:text-4xl md:text-5xl text-[#FAFAFA] leading-tight mb-6">
              Why SuleClaw exists
            </h2>
            ...
            {/* Location */}
            <div className="mt-8 flex items-center gap-2 text-[#52525B]">
          ...
          <div className="hidden lg:flex items-center justify-center">
            ...
            >
              ...
              >
                ...
                />
                {/* Corner accents */}
                <rect x="0" y="0" width="48" height="48" fill="#F59E0B" fillOpacity="0.04" />
                <rect x="240" y="240" width="48" height="48" fill="#F59E0B" fillOpacity="0.04" />
              </svg>

              {/* Center label */}
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="font-headline font-bold text-4xl text-[#F59E0B]/20">
                  SC
                </span>
              </div>
            </div>
